...
export class FacebookAuthenticationService {
  constructor (
    ...
    private readonly loadAccountRepo: LoadUserAccountRepository & SaveFacebookAccountRepository,
  ...
  async perform (
    ...
    if (fbData !== undefined) {
      ...
      const { id } = await this.loadAccountRepo.saveWithFacebook(fbAccount)
