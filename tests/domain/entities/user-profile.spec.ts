...
describe('UserProfile', () => {
  ...
  it('should create with empty initials when picture is provided ', () => {
  ...
  it('should create initials with first letter of first and last names ', () => {
    sut.setPicture({ name: 'gabriel oliveira' })
  ...
  it('should create initials with two letter of first name ', () => {
    sut.setPicture({ name: 'gabriel' })
